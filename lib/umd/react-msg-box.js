(function (global, factory) {
  ...
  (factory((global.ReactMsgBox = {}),global.React,global.PropTypes,global.ReactDOM));
    ...
    _createClass(MessageBoxEl, [{
      ...
      value: function render() {
        ...
        return React__default.createElement("div", {
          ...
          className: clsN,
          style: styles
        }, type === "confirm" && React__default.createElement(Confirm, _extends({}, this.state, {
          handleAction: this.handleAction.bind(this)
        })), type === "alert" && React__default.createElement(Alert, _extends({}, this.state, {
          handleAction: this.handleAction.bind(this)
        })), type === "toast" && React__default.createElement(Toast, this.state), type === "custom" && React__default.createElement(Custom, _extends({}, this.state, {
          instance: this
        })));
      }
    }]);
  ...
  var Alert = function Alert(props) {
    ...
    }, children || message)), React__default.createElement("div", {
      className: "m-msgbox-btn"
    }, showConfirmButton && React__default.createElement("div", {
  ...
  var Confirm = function Confirm(props) {
    ...
    return React__default.createElement("div", {
      ...
      className: "m-msgbox-btn"
    }, showCancelButton && React__default.createElement("div", {
      className: "m-cancel-btn",
      onClick: handleAction.bind(_this5, 'cancel')
    }, cancelButtonText), showConfirmButton && React__default.createElement("div", {
      className: "m-confirm-btn",
      onClick: handleAction.bind(_this5, 'confirm')
    }, confirmButtonText)));
  };
    ...
    render: function render(options) {
      ...
      return new Promise(function (resolve, reject) {
        ...
        if (instance) {
          ...
          instance = ReactDOM.render(React__default.createElement(MessageBoxEl, _extends({
            ref: function ref(t) {
              instance = t;
            }
          }, options)), domEl); // 存储实例
  ...
  var MessageBox = {
    ...
    alert: function alert(message) {
      ...
      if (!React__default.isValidElement(message) && _typeof(message) === 'object') {
        options = message;
      }
    ...
    custom: function custom(message) {
      ...
      if (!React__default.isValidElement(message) && typeof message !== 'function' && _typeof(message) === 'object') {
        options = message;
      }
  ...
  exports.MessageBoxEl = MessageBoxEl;
